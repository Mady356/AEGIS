...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # Static
        # Root → cold open intro (replaces the V1 boot div).
        # Cockpit lives at /cockpit. Cold open redirects there on resolve.
        if p == "/" or p == "/cold_open.html":
            return self._send_static(ROOT / "cold_open.html")
        if p == "/cockpit" or p == "/cockpit.html" or p == "/index.html":
